...
var sentence_negative = {
    ...
    tc: [
        "你們一週比一週糟糕，一週比一週爛。 #B很好玩嗎? 學校，是你們學習的地方! ",
        "不要#B，講過多少遍了? 不論我們再如何宣導，依舊有人一犯再犯。",
        "你們不要因為學期末了就開始浮躁，亂七八糟! ",
        "不要以為你們可以這樣胡鬧。 只要你們在康乃爾一天，就代表學校的聲譽。 在其他人的眼裡，因為你個人的行為，整個學校都會被貼上這個負面的標籤。",
        "這些規則，一條條的列在校規裡。 爾後，違反這些規則，就視同和學校做對，跟校規作對! 再被我抓到，我肯定直接叫家長來接你!",
        "我一次又一次的強調，#B是不被容許的事情。 發條太鬆了是不是? 自律能力跑到哪裡了? ",
        "把這裡當你家嗎? 不要一副「付錢我最大」的樣子。 這裡是學校! 是有校規的! ",
        "爾後，我一律不容許這種挑戰學校的事情發生! ",
        "服從、禮儀，是學生最基本的品德。 公然在學校#B、挑戰權威，你還算是個學生嗎? "
    ]
}
...
var verb = {
    ...
    tc: [
        "在走廊上", "在教室裡", "在別人頭上", "在地板上", "在校車上", "在校門口"
    ]
}
...
/*
     FILE ARCHIVED ON 13:05:28 Dec 14, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 04:57:30 Feb 20, 2020.
...
playback timings (ms):
  ...
  CDXLines.iter: 12.071 (3)
  PetaboxLoader3.datanode: 1072.554 (4)
  esindex: 0.013
  captures_list: 1073.448
  exclusion.robots: 0.218
  LoadShardBlock: 1056.894 (3)
  PetaboxLoader3.resolve: 59.912
  exclusion.robots.policy: 0.194
  load_resource: 80.606
*/